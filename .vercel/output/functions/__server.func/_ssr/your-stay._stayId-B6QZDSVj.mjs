import { T as useBookingStore, f as formatLongDate, h as guestLabel, m as getVilla, r as DESTINATION, w as stayGuestLabel } from "./store-DTEBiuLL.mjs";
...
import { n as Route } from "./router-BGy6B_af.mjs";
import { t as Photo } from "./photo-CUmLyG3P.mjs";
import { t as StaySummary } from "./stay-summary-OEbMa8By.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/your-stay._stayId-B6QZDSVj.js
...
function YourStayPage() {
	...
	if (!stay && request && request.status !== "CONFIRMED") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate, {
