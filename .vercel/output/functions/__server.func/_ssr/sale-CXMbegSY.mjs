...
import { t as vi } from "../_libs/date-fns.mjs";
import { C as paymentRuleOf, E as villas, S as paymentRuleLabel, T as useBookingStore, _ as isIsoDate, a as SALE_MAI, g as isAvailable, p as formatVnd, y as nightsBetween } from "./store-DTEBiuLL.mjs";
import { a as quoteText, i as paymentLinkText, n as domainMessageVi, o as requestStatusVi, r as holdCountdown, s as viDateRange, t as commissionStatusVi } from "./copy-CmdC2Qzr.mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { t as Button } from "./button-Cj0Y92zJ.mjs";
import { t as Drawer } from "../_libs/vaul.mjs";
import { i as GuestField, n as DateRangeField, r as FieldSplit } from "./dates-guests-Darjg6bE.mjs";
import { t as Photo } from "./photo-CUmLyG3P.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sale-CXMbegSY.js
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusPill, { children: requestStatusVi(request.status) })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							request.status === "ACCEPTED" && request.holdExpiresAt ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-4 rounded-xl bg-lotus-soft p-3",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "text-sm font-medium text-lotus-deep",
									children: ["Giữ chỗ còn ", holdCountdown(request.holdExpiresAt, now)]
							...
							request.status === "CONFIRMED" && request.reference ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-3 text-sm text-muted",
								children: [
									"Mã đặt",
									" ",
...
function SaleVillaRow({ villa, open, nights, guests, ready, copied, onQuote, onCreate }) {
					...
					children: [
						...
						ready ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								className: "text-muted",
								children: [" · ", paymentRuleLabel(paymentRuleOf(villa.id))]
							})]
						}) : null
					]
				})]
