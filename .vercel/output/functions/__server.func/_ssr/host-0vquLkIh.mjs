...
import { D as useBookingStore, E as stayGuestLabel, O as villas, T as paymentPlanLabel, _ as hostToday, d as commitmentsOnDate, h as getVilla, m as formatVnd } from "./store-Eq8rYrIv.mjs";
import { a as formatDueAt, f as requestStatusVi, i as domainMessageVi, l as personaLabel, o as holdCountdown, p as viDateRange, r as commitmentCellLabel, s as hostPaymentStatus, t as balanceLine } from "./copy-DhNapS8c.mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { t as Button } from "./button-CdPly7rM.mjs";
import { t as Drawer } from "../_libs/vaul.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/host-0vquLkIh.js
...
function HostCalendar({ world, onExternal, onBlock, onRelease }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
				...
				}, date))] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: villas.map((villa) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: `flex h-16 w-20 flex-col justify-center rounded-lg px-1.5 text-left text-[11px] leading-tight ${conflict ? "bg-lotus-soft text-lotus-deep" : items[0]?.kind === "HOLD" ? "bg-sand text-ink" : items[0]?.kind === "AVAILABILITY_BLOCK" ? "bg-cream-deep text-ink-soft" : items[0] ? "bg-paper text-ink shadow-[var(--shadow-border)]" : "bg-cream text-muted"}`,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function HostPage() {
	...
	const holding = world.requests.filter((item) => item.status === "ACCEPTED" && !world.bookings.some((booking) => booking.requestId === item.id && booking.status === "CONFIRMED"));
	const bookedRequests = world.requests.filter((item) => world.bookings.some((booking) => booking.requestId === item.id && booking.status === "CONFIRMED"));
	function run(action) {
		setError(null);
		try {
			action();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			tab === "today" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TodayCard, {
						...
						children: summary.pending.map((request) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm",
							children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TodayCard, {
						...
						count: summary.arriving.length,
						onClick: () => setTab("stays"),
						children: summary.arriving.map((stay) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm",
							children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TodayCard, {
						...
						count: summary.departing.length,
						onClick: () => setTab("stays"),
						children: summary.departing.map((stay) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm",
							children: [
								getVilla(stay.villaId)?.name,
								" · ",
			...
			tab === "stays" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "mx-auto max-w-lg space-y-3 px-4 pt-5 sm:px-6",
				children: world.stays.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
