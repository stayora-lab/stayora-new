...
import { P as stayGuestLabel, T as opsLists, _ as getVilla } from "./engine-Dt7igvIP.mjs";
import { i as domainMessageVi, p as viDateRange } from "./copy-BI05OUcm.mjs";
...
import { t as DateField } from "./dates-guests-oK990JZY.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ops-DBg0qimY.js
...
function OpsPage() {
	...
	const role = isBql ? { persona: "BQL" } : {
		persona: "BUTLER",
		butlerId: butlerId ?? "butler-linh"
	};
	const butler = world.butlers.find((person) => person.id === (butlerId ?? "butler-linh"));
							...
							sheet?.kind === "noshow" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									...
									children: [
										...
										" · ",
										visibleGuestName(sheet.stay, role),
...
function StayList({ title, stays, empty, canAct, assigned, role, onCheckIn, onCheckOut, onNoShow, onIncident }) {
...
function StayRow({ stay, role, canAct, onCheckIn, onCheckOut, onNoShow, onIncident }) {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: visibleGuestName(stay, role)
