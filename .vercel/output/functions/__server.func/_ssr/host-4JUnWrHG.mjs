...
import { E as paymentPlanLabel, F as villas, I as villasForHost, P as stayGuestLabel, _ as getVilla, f as commitmentsOnDate, y as hostToday } from "./engine-Dt7igvIP.mjs";
import { a as formatDueAt, f as requestStatusVi, i as domainMessageVi, l as personaLabel, o as holdCountdown, p as viDateRange, r as commitmentCellLabel, s as hostPaymentStatus, t as balanceLine } from "./copy-BI05OUcm.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { o as TriangleAlert } from "../_libs/lucide-react.mjs";
import { b as useBookingStore, c as Button, h as formatVnd, o as RoleGate } from "./router-BdOyuEru.mjs";
import { t as visibleGuestName } from "./privacy-Df_aib37.mjs";
import { t as Drawer } from "../_libs/vaul.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/host-4JUnWrHG.js
...
function CommitmentDetail({ world, commitment, onRelease }) {
	...
	const guestLabel = stay ? visibleGuestName(stay, {
		persona: "HOST",
		hostId
	}) : null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [viDateRange(commitment.start, commitment.end), stay ? ` · ${guestLabel} · ${stay.guests} khách` : null]
			}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TodayCard, {
							...
							children: todayArriving.map((stay) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									...
									" · ",
									visibleGuestName(stay, hostRole),
									" · ",
									stay.originLabel
								]
							}, stay.id))
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: visibleGuestName(stay, hostRole)
									})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function RequestCard({ request, clock, action, worldLines, booked }) {
	...
	const hostId = useBookingStore((state) => state.hostId);
	const sale = request.saleId ? sales.find((person) => person.id === request.saleId) : void 0;
