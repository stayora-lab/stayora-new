...
import { a as parseVai, c as workspaceFor, n as PILOT_SEED, r as ROLE_STORAGE_KEY, s as vaiFor } from "./role-BziMqN6s.mjs";
...
import { a as PILOT_NOW, b as isAvailable, m as createEmptyWorld, r as DomainError, w as occupiedRanges } from "./engine-Dt7igvIP.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/store-BbOnBQRm.js
...
var resolveRole = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("578d5fcf4a01b27257ec01c83c94109ebcd59c716ab0f90c75e9fec588185572"));
...
var useBookingStore = create()(persist((set, get) => ({
	...
	setRole: (role) => set({
		...
		adminKey: role.persona === "ADMIN" ? get().adminKey : void 0
	}),
	...
	applyVaiFromUrl: async () => {
		...
		const sessionKey = urlKey || sessionStorage.getItem("stayora-admin-key") || void 0;
		const role = parseVai(vai);
		if (role?.persona === "ADMIN") {
			if ((await resolveRole({ data: {
				vai: "admin",
				key: sessionKey
			} })).persona !== "ADMIN") {
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/mark-C2l2-7J3.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-BdOyuEru.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			persona === "ADMIN" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				...
				onClick: () => {
					if (window.confirm("Nạp lại dữ liệu thử? Dữ liệu phiên này sẽ bị thay.")) resetWorld();
				},
				children: "Nạp lại dữ liệu thử"
			}) : null
		]
	});
}
...
//#endregion
export { isIsoDate as _, Route$8 as a, useBookingStore as b, Button as c, bookabilityCopy as d, cn as f, guestLabel as g, formatVnd as h, Route$2 as i, bedroomLabel as l, formatDateRange as m, Route as n, RoleGate as o, disabledMatchers as p, Route$1 as r, StayoraIcon as s, router_exports as t, bookability as u, nightLabel as v, nightsBetween as y };
