...
import { T as useBookingStore, _ as isIsoDate, d as formatDateRange, h as guestLabel, l as cn, m as getVilla, o as bedroomLabel, p as formatVnd, r as DESTINATION, s as bookability, t as AMENITY_LABELS, v as nightLabel, y as nightsBetween } from "./store-DTEBiuLL.mjs";
...
import { i as GuestField, n as DateRangeField } from "./dates-guests-Darjg6bE.mjs";
import { b as useNavigate, v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { r as Route$1 } from "./router-BGy6B_af.mjs";
import { t as Photo } from "./photo-CUmLyG3P.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/villas._villaId-C2OUZY7y.js
...
function VillaDetail({ villa }) {
	...
	const booking = {
		...
		existing: existing ? {
			...
			onOpen: () => {
				if (existing.status === "CONFIRMED" && existing.stayId) navigate({
					to: "/your-stay/$stayId",
					params: { stayId: existing.stayId }
				});
				else navigate({
					to: "/requests/$requestId",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "font-medium",
							children: "From recent guests"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-4 grid gap-4",
							children: villa.reviews.map((review) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("blockquote", {
