...
import { T as useBookingStore, l as cn, x as parseStaySearch } from "./store-DTEBiuLL.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BGy6B_af.js
...
function SiteHeader() {
	...
	const persona = useBookingStore((state) => state.persona);
	const latest = useBookingStore((state) => state.world.requests.find((item) => item.source === "GUEST"));
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [hydrated && persona === "GUEST" && latest ? latest.status === "CONFIRMED" && latest.stayId ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/your-stay/$stayId",
...
var styles_default = "/assets/styles-DFyTJoRO.css";
...
var Route$7 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Stayora — private villas at Oceanami, Phước Hải. Request a stay, wait for confirmation, then arrive."
			},
			{
				name: "theme-color",
				content: "#F6F1EA"
