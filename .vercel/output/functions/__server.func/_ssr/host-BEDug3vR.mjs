...
import { S as paymentPlanLabel, m as getVilla, p as formatVnd, w as useBookingStore } from "./store-CN_mVyeU.mjs";
import { n as domainMessageVi, o as requestStatusVi, r as holdCountdown, s as viDateRange } from "./copy-CJYuN2Fk.mjs";
import { n as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { t as Button } from "./button-B_fynA1P.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/host-BEDug3vR.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
				...
				children: holding.map((request) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RequestCard, {
						...
						action: unknown ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						}) : initial ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
				...
				children: [bookedRequests.map((request) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RequestCard, {
					...
					clock,
					booked: true,
					extra: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-3 text-sm text-muted",
						children: [
							"Mã",
							" ",
				...
				}, request.id)), occupancyBookings.map((booking) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
